...
public static function clientes($a,$link)
    ...
    public static function producto($a,$link)
                ...
                foreach($a[0] as $key=>$value){
                        ...
                        if($link!=0){
                            ...
                            echo "<th align='center'>Cotizar</th>";
                            echo "<th align='center'>Editar</th>";
                            echo "<th align='center'>Eliminar</th>";
                        }
                            echo "</thead>";
        ...
        if($link!=0){
            echo "<td align='center'><a class='btn btn-warning' href='?controlador=producto&accion=cotizar&ID=".$r->ID." '>Cotizar</a></td>";
    ...
    public static function cotizar($a,$link)
                     {
                         echo '<table  class="table table-bordered">';
                         echo "<thead class='thead-dark'> <tr>";
                         echo "<th scope='col' style='display:none;' >"; 
             ...
             if($link!=0){
                 echo "<td align='center' width='10px'><a class='btn btn-danger' href='?controlador=producto&accion=quitarcoti&ID=".$r->ID." '>Borrar</a></td>";
             }
         }
                         echo "</tr>";
                         echo '</tbody></table>';
