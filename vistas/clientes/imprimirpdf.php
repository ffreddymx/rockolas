...
$this->SetXY(70,20);
$this->Cell(0,6,utf8_decode("Renta de Rocolas"),0,1,'L');
    $this->SetFont('Arial','',9);
    $this->SetXY(70,23);
    $this->Cell(0,6,utf8_decode("Lista de Clientes"),0,1,'L');
...
//==========================================================================      Cuerpo del programas
    ...
    if(($id)=='')
     ...
     $pdf->SetWidths(array(50,30,15,20,20,20,40 ));
    ...
    for($i=0;$i<1;$i++)
            {
                $pdf->Row(array(('Nombre'),('Apellidos'),'Sexo',utf8_decode('Teléfono'),'Email','Bar',utf8_decode('Dirección')),'L');
            }
  ...
  //  $pdf->SetFillColor(224,235,255);
    ...
    $pdf->SetFont('Arial','',8);
        ...
        $pdf->Row(array($alu->Nombre,$alu->Apellidos,$alu->Sexo,$alu->Telefono,$alu->Email,$alu->Bar,$alu->Direccion),'L');
        }
